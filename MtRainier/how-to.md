...
- `build-module.ps1`
  - Builds the module DLL (`./bin/MtRainier.private.dll`), creates the exported cmdlets, generates custom cmdlet test stubs, and updates `./MtRainier.psd1` with Azure profile information.
