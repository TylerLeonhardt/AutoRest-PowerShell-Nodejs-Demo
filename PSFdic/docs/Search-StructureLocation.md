...
online version: https://docs.microsoft.com/en-us/powershell/module/fdicbankdataapibeta/search-structurelocation
schema: 2.0.0
---

# Search-StructureLocation
...
```
Search-StructureLocation [-Download <String>] [-Fields <String>] [-Filename <String>] [-Filters <String>]
...
### Sample.API.Models.IPathsL90G6VLocationsGetResponses200ContentApplicationJsonSchema
