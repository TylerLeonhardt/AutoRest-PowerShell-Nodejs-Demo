# How-To
This document describes how to develop for `FdicBankDataApiBeta`.

## Building `FdicBankDataApiBeta`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `FdicBankDataApiBeta` into the session.
